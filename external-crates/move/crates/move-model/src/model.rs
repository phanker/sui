        ...
        match sig {
            ...
            SignatureToken::DataType(handle_idx) => {
                let struct_view = DataTypeHandleView::new(
                    &self.data.module,
                    self.data.module.data_type_handle_at(*handle_idx),
                );
    ...
    pub fn get_identifier(&self) -> Option<Identifier> {
        match &self.data.info {
            StructInfo::Declared { handle_idx, .. } => {
                let handle = self.module_env.data.module.data_type_handle_at(*handle_idx);
                Some(
                    self.module_env
                        .data
                        .module
        ...
        match &self.data.info {
            StructInfo::Declared { def_idx, .. } => {
                ...
                let handle = self
                    ...
                    .data
                    .module
                    .data_type_handle_at(def.struct_handle);
                handle.abilities
            }
